...
folder1="/data1st2/hannan_25/data/snATAC_process/snATAC_01_bam/MW47A_HIP/outs/"
folder2="/data1st2/hannan_25/data/snATAC_process/snATAC_01_bam/MW51A_HIP/outs/"
folder3="/data1st2/hannan_25/data/snATAC_process/snATAC_01_bam/MW45A_HIP/outs/"

# Define the output folder for merged files
output_dir="/data2st2/junyi/output/atac1112/tobiasbam/MWBULK_HIP"
