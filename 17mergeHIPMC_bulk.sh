...
folder1="/data1st2/hannan_25/data/snATAC_process/snATAC_01_bam/MC39C_HIP/outs/"
folder2="/data1st2/hannan_25/data/snATAC_process/snATAC_01_bam/MC48D_HIP/outs/"
folder3="/data1st2/hannan_25/data/snATAC_process/snATAC_01_bam/MC50B_HIP/outs/"

# Define the output folder for merged files
output_dir="/data2st2/junyi/output/atac1112/tobiasbam/MCBULK_HIP"
