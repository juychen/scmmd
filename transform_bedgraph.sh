...
input_folder="/data2st1/junyi/methlyatlas/atac/catlas.org/renlab_downloads/wholemousebrain/bigwig_macs2/"
output_folder="/data2st1/junyi/atac_bigbed/"
...
for bw_file in "$input_folder"/*.bw; do
