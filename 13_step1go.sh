...
# Python script
# Python script
python_script="/home/junyichen/code/scmmd/example_go_merge_and_predict3.py"

# Mapping and class info
go_group_path="/data2st1/junyi/output/atac1112/tobias/2-4 DEGl1.xlsx"
...
deg_paths=(
'/data2st1/junyi/output/atac1112/dar/celltype.L2/MASTNG_dar_coaccess.csv'
)
...
--input /data2st1/junyi/output/atac1112/dar/celltype.L2/MASTNG_dar_coaccess
