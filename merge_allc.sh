...
allcools merge-allc --chrom_size_path /home/junyichen/code/whole_mouse_brain/wmb/files/mm10.main.chrom.sizes --allc_paths /data2st1/junyi/single_allcs/HIP/Neuron/*gz --output_path /data2st1/junyi/merged_allcs/HIP/Neuron.tsv.gz
