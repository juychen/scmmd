...
Rscript 11darmast_dmr.R --input /data2st1/junyi/output/atac1112/subset/dmr_region_nt/PFC_5hmC.h5ad --output /data2st1/junyi/output/atac1112/dar/region/MASTdmr --region "PFC" &\