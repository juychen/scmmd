...
input_folder="/data2st1/junyi/methlyatlas/mCseq/data.nemoarchive.org/biccn/grant/u19_cemba/ecker/epigenome/cellgroup/mCseq3/mouse/processed/other/"
output_folder="/data2st1/junyi/snmc_bedgraph/"
...
for bw_file in "$input_folder"/*CGN*.bw; do
    # Get the base name of the file (without extension)
    base_name=$(basename "$bw_file" .bw)

    # Define the output BedGraph file path
    bedgraph_file="$output_folder/$base_name.bedGraph"
