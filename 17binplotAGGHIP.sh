...
output_dir="/data2st2/junyi/output/atac1112/tobiasbam/HIP_Jaspar26/"
...
for bam_file in "$folder1"/*footprints.bw; do
    ...
    for bed_bind in /data2st2/junyi/output/atac1112/tobiasbam/HIP_Jaspar26/$filename/*/beds/*_all.bed; do
