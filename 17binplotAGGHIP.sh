...
folder1="/data2st2/junyi/output/atac1112/tobiasbam/MC_HIP/corrected/"
folder2="/data2st2/junyi/output/atac1112/tobiasbam/MW_HIP/corrected/"

folderTF=""

# Define the output folder for merged files
output_dir="/data2st2/junyi/output/atac1112/tobiasbam/HIPcisbp_BIND/"
...
for bam_file in "$folder1"/*footprints.bw; do
    ...
    for bed_bind in /data2st2/junyi/output/atac1112/tobiasbam/HIPcisbp_BIND/$filename/*/beds/*_all.bed; do
        ...
        if [[ -f "$folder2/$new_name" ]]; then
            ...
            # If finish the write a text to '/data2st2/junyi/output/atac1112/tobiasbam/MW_HIP/finish_list'
    else
