...
input_folder="/data2st1/junyi/methlyatlas/atac/catlas.org/renlab_downloads/wholemousebrain/bed/subclass/"
output_folder="/data2st1/junyi/atac_bedpeak/"
...
for bw_file in "$input_folder"/*.bed.gz; do
    # Get the base name of the file (without extension)
    base_name=$(basename "$bw_file" .bed.gz)
