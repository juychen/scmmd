...
for folder in /data2st2/junyi/output/atac1112/tobiasbam/M*_HIP; do
  echo $folder
  ...
  for file in $folder/*; do
    ...
    if [[ $file == *.bam ]]; then
      ...
      if [[ -f $out_bam ]]; then
        ...
        out_bw=$folder/corrected/$ctname\_track.bw
        ...
        if [[ ! -f $out_bw ]]; then
          ...
          -b $out_bam \
          -o $out_bw \
          --blackListFileName /data2st1/junyi/ref/mm10-blacklist.v2.bed \
          --binSize 10 \
          --normalizeUsing CPM \
