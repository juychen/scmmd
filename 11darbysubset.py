...
parser.add_argument("--input", type=str, required=False, help="Input file for the h5ad generated by snapATAC2",
                    default="/data1st2/junyi/output/atac1112/subset/region_nt/HIP_HIP_Glut.h5ad")
...
for celltype in adata.obs[celltype_column].unique():
    try:
        ...
        if args.method == "wilcoxon":
            ...
            df = sc.get.rank_genes_groups_df(adata_subset, group='MC', key='rank_genes_groups')
            df.to_csv(f"{outfolder}/{base_name}_wilcoxon.csv")
