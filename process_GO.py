...
def merge_go_data(go_dir_path, go_group_path, df_class_path, output_path,
    ...
    for file in os.listdir(go_dir_path):
        ...
        if file.startswith('GO_gsea') and (file.endswith('Down.csv') or file.endswith('Up.csv')):
...
if __name__ == "__main__":
    ...
    parser.add_argument("--go_dir_path", type=str,
                        default="/data1st2/hannan_25/data/RNAexp/snRNA/GSEA/merge_SCH_new_no_filter_deg_outputs/all_company_ngeneson_saturation_downsampled_ratio/adata_SUS_4v4_downsampled_ratio_mast/",
                        help="GO enrichment results directory path")
    parser.add_argument("--go_group_path", type=str,
                        default="/data7/mark/STG/dataset/snRNA/merge_SCH/2 go_term_mapping_group_20250923.xlsx",
                        help="GO grouping mapping file path")
    parser.add_argument("--df_class_path", type=str,
                        default="/data7/mark/STG/dataset/ST_HD_Ex_out/function_analysis/sn_ST_cell_DEG_number/sn_scST_CUMS_class_DEGs/name_form_v2.xlsx",
                        help="Class mapping file path")

    # Output parameters
    parser.add_argument("--output_path", type=str,
                        default="/data1st2/hannan_25/data/RNAexp/snRNA/GSEA/GO_heatmap//filter/2_go_merged_with_predictions.csv",
