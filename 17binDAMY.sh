...
folder1="/data2st2/junyi/output/atac0627/tobiasbam/MC_AMY/corrected/"
folder2="/data2st2/junyi/output/atac0627/tobiasbam/MW_AMY/corrected/"

# Define the output folder for merged files
output_dir="/data2st2/junyi/output/atac0627/tobiasbam/AMY"
...
for bam_file in "$folder1"/*footprints.bw; do
    ...
    if [[ -f "$folder2/$new_name" ]]; then
        ...
        if [[ ! -f "$output_dir/finish_list/$filename.txt" ]]; then
            ...
            --outdir /data2st2/junyi/output/atac0627/tobiasbam/MC_AMY/ --cond_names MC MW --cores 32 \
