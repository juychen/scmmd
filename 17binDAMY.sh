...
folder1="/data2st2/junyi/output/atac1112/tobiasbam/MC_AMY/corrected/"
folder2="/data2st2/junyi/output/atac1112/tobiasbam/MW_AMY/corrected/"

# Define the output folder for merged files
output_dir="/data2st2/junyi/output/atac1112/tobiasbam/AMY_Jaspar26DEG/"
...
for bam_file in "$folder1"/*footprints.bw; do
    ...
    if [[ -f "$folder2/$new_name" ]]; then
        ...
        if [[ ! -f "$output_dir/finish_list/$filename.txt" ]]; then
            ...
            --peaks /data2st1/junyi/output/atac1112/cCRE/L2degpeaks/AMY_${ctname:4:-3}.bed \
